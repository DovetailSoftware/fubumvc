...
namespace FubuMVC.Tests.View.Spark.SparkModel.Policies
{
    [TestFixture]
    public class NamespacePolicyTester : InteractionContext<NamespacePolicy>
    {
        ...
        public void namespace_of_files_that_are_located_in_nested_directory_is_set_correctly()
        {
            ...
            _template.Descriptor.As<SparkDescriptor>().Namespace.ShouldEqual("FubuMVC.Tests.a.b.c");
        }
        ...
        {
            ClassUnderTest.Apply(_template);
            _template.Descriptor.As<SparkDescriptor>().Namespace.ShouldEqual("FubuMVC.Tests");
        }
