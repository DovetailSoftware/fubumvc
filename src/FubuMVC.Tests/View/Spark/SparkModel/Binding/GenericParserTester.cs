...
namespace FubuMVC.Tests.View.Spark.SparkModel.Binding
{
    [TestFixture]
    public class GenericParserTester
    {
        ...
        {
            var duplicatedGenericExtraAssembly = generateAssembly("namespace FubuMVC.Tests.View.Spark.SparkModel.Binding{public class DuplicatedGeneric<T>{} public class Duplicated{} }");
        ...
        public void should_return_null_when_type_is_not_in_assemblies()
        {
            ...
            const string typeName = "FubuMVC.Tests.View.Spark.SparkModel.Binding.Generic<FubuMVC.Tests.View.Spark.SparkModel.Binding.Baz>";
        ...
        public void should_return_null_when_generic_argument_type_is_not_in_assemblies()
        {
            ...
            const string typeName = "FubuMVC.Tests.View.Spark.SparkModel.Binding.Generic<FubuMVC.Tests.View.Spark.SparkModel.Binding.Baz, System.String>";
        ...
        {
            const string typeName = "FubuMVC.Tests.View.Spark.SparkModel.Binding.Generic<FubuMVC.Tests.View.Spark.SparkModel.Binding.Baz, FubuMVC.Tests.View.Spark.SparkModel.Binding.Bar>";
        ...
        {
            var typeDefinition = new GenericTypeDefinition { OpenTypeName = "FubuMVC.Tests.View.Spark.SparkModel.Binding.DuplicatedGeneric`1", ArgumentTypeNames = new[] { "System.String" } };
        ...
        {
            var typeDefinition = new GenericTypeDefinition { OpenTypeName = "FubuMVC.Tests.View.Spark.SparkModel.Binding.Generic`1", ArgumentTypeNames = new[] { "NOTFOUND" } };
        ...
        {
            var typeDefinition = new GenericTypeDefinition { OpenTypeName = "FubuMVC.Tests.View.Spark.SparkModel.Binding.Generic`1", ArgumentTypeNames = new[] { "FubuMVC.Tests.View.Spark.SparkModel.Binding.Duplicated" } };
