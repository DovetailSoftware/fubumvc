...
namespace FubuMVC.Tests.View.Spark.SparkModel.Binding
{
    ...
    public class ViewModelBinderTester : InteractionContext<ViewModelBinder<ITemplate>>
    {
        ...
        protected override void beforeEach()
        {
            ...
            {
                ViewModelType = "FubuMVC.Tests.View.Spark.SparkModel.Binding.Baz"
            };
        ...
        private TypePool typePool()
        {
            ...
            pool.AddType(generateType("namespace FubuMVC.Tests.View.Spark.SparkModel.Binding{public class Bar{}}", "FubuMVC.Tests.View.Spark.SparkModel.Binding.Bar"));
            pool.AddType<Bar>();
            pool.AddType<Baz>();
