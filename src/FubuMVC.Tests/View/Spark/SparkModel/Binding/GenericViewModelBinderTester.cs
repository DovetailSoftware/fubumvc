...
namespace FubuMVC.Tests.View.Spark.SparkModel.Binding
{
    ...
    public class GenericViewModelBinderTester : InteractionContext<GenericViewModelBinder<ITemplate>>
    {
        ...
        protected override void beforeEach()
        {
            ...
            {
                ViewModelType = "FubuMVC.Tests.View.Spark.SparkModel.Binding.Generic<FubuMVC.Tests.View.Spark.SparkModel.Binding.Baz>"                               
            };
        ...
        {
            _parsing.ViewModelType = "FubuMVC.Tests.View.Spark.SparkModel.Binding.DuplicatedGeneric<FubuMVC.Tests.View.Spark.SparkModel.Binding.Bar>";
        ...
        {
            _parsing.ViewModelType = "x.y.jazz<FubuMVC.Tests.View.Spark.SparkModel.Binding.Bar>";
            ClassUnderTest.Bind(_request);
        ...
        private TypePool typePool()
        {
            ...
            var externalAssemblyDuplicatedType = generateType("namespace FubuMVC.Tests.View.Spark.SparkModel.Binding{public class DuplicatedGeneric<T>{}}", "FubuMVC.Tests.View.Spark.SparkModel.Binding.DuplicatedGeneric`1");
