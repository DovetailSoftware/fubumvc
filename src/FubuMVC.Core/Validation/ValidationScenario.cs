...
namespace FubuMVC.Core.Validation
{
    public class ValidationScenario<T>
    {
        ...
        public class ScenarioDefinition
        {
            ...
            public void ValidationSource<U>(U source)
                where U : IValidationSource
            {
                _sources.Add(source);
            }

            public void Rule<U>(U rule)
                where U : IValidationRule
            {
                _rules.Add(rule);
            }

            public void FieldRule<U>(U rule)
                where U : IFieldValidationRule
            {
